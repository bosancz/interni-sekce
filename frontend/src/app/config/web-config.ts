import { WebConfigStructure } from "src/app/schema/web-config-structure";
		...
		items: [
			{
				...
				type: "string",
				default: "Název webu",
				help: "Zobrazí se v záhlaví prohlížeče.",
			},
			...
			{
				name: "canalAttendeesUrl",
				label: "Obsazenost tréninku v Tróji",
				type: "string",
				help: "Odkaz na tabulku.",
			},
		],
	},
