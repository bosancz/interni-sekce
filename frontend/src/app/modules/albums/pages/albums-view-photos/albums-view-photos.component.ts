...
export class AlbumsViewPhotosComponent implements OnInit, ViewWillLeave {
	album?: BackendApiTypes.AlbumResponseWithLinks;

	photos?: BackendApiTypes.PhotoResponseWithLinks[];
	...
	oldOrder?: BackendApiTypes.PhotoResponseWithLinks[];

	showCheckboxes = false;
	selectedPhotos: BackendApiTypes.PhotoResponseWithLinks[] = [];
	...
	onPhotoClick(event: CustomEvent<BackendApiTypes.PhotoResponseWithLinks | undefined>) {
	...
	async openPhoto(photo: BackendApiTypes.PhotoResponseWithLinks) {
	...
	private getActions(album: BackendApiTypes.AlbumResponseWithLinks): Action[] {
		return [
			{
				text: "Seřadit",
