...
export class UsersViewComponent {
	...
	private impersonateUser(user: BackendApiTypes.UserResponseWithLinks) {}

	private deleteUser(user: BackendApiTypes.UserResponseWithLinks) {}

	private setActions(user: BackendApiTypes.UserResponseWithLinks) {
		this.actions = [
			{
