...
export const EventsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listEvents: async (year?: number, status?: string, search?: string, my?: boolean, noleader?: boolean, limit?: number, offset?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/events`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const EventsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listEvents(year?: number, status?: string, search?: string, my?: boolean, noleader?: boolean, limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<EventResponseWithLinks>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listEvents(year, status, search, my, noleader, limit, offset, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const EventsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        listEvents(requestParameters: EventsApiListEventsRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Array<EventResponseWithLinks>> {
            return localVarFp.listEvents(requestParameters.year, requestParameters.status, requestParameters.search, requestParameters.my, requestParameters.noleader, requestParameters.limit, requestParameters.offset, options).then((request) => request(axios, basePath));
        },
        /**
         * 
...
export class EventsApi extends BaseAPI {
    ...
    public listEvents(queryParams: EventsApiListEventsQueryParams = {}, options?: AxiosRequestConfig) {
        return EventsApiFp(this.configuration).listEvents(queryParams.year, queryParams.status, queryParams.search, queryParams.my, queryParams.noleader, queryParams.limit, queryParams.offset, options).then((request) => request(this.axios, this.basePath));
    }
...
export const PhotoGalleryApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listAlbums(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AlbumResponseWithLinks>>> {
