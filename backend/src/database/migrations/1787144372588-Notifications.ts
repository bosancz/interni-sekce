...
export class Notifications1787144372588 implements MigrationInterface {
    name = 'Notifications1787144372588'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."notification_settings_channel_enum" AS ENUM('disabled', 'push', 'email', 'both')`);
        await queryRunner.query(`CREATE TABLE "notification_settings" ("user_id" integer NOT NULL, "type" "public"."notification_settings_type_enum" NOT NULL, "channel" "public"."notification_settings_channel_enum" NOT NULL, CONSTRAINT "PK_ff98348bd5a8e07a7f3243a969c" PRIMARY KEY ("user_id", "type"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."notification_settings_channel_enum"`);
