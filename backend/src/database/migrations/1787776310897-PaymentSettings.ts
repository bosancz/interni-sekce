...
export class PaymentSettings1787776310897 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "payment_settings" ("id" SERIAL NOT NULL, "account_number" character varying NOT NULL, "bank_code" character varying NOT NULL, "iban" character varying NOT NULL, "amount" integer NOT NULL, "currency" character varying NOT NULL, CONSTRAINT "PK_78624861ce2178d6835fb1d9fdf" PRIMARY KEY ("id"))`,
		);
