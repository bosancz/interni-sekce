...
export class albumsEventsMoveId1674747422432 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "albums" ADD CONSTRAINT "UQ_ae25e5f656138bf2d404a002b2b" UNIQUE ("event_id")`,
		);
		await queryRunner.query(
			`ALTER TABLE "albums" ADD CONSTRAINT "FK_ae25e5f656138bf2d404a002b2b" FOREIGN KEY ("event_id") REFERENCES "events"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
	}
