...
export class albumsPhotoFace1673540650873 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "photo_faces" ("id" SERIAL NOT NULL, "photo_id" integer NOT NULL, "member_id" integer, "location" integer array NOT NULL, "descriptor" cube NOT NULL, CONSTRAINT "PK_3113b2dcbbd3fd2a30927aa2b36" PRIMARY KEY ("id"))`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "photo_faces" ADD CONSTRAINT "FK_85f717bcf5979c9a977051fb0b1" FOREIGN KEY ("member_id") REFERENCES "members"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
		);
	}
