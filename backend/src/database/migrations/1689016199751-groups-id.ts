...
export class GroupsId1689016199751 implements MigrationInterface {
	name = "GroupsId1689016199751";

	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(`ALTER TABLE "groups" ADD "short_name" character varying NOT NULL DEFAULT 'XX'`);
		await queryRunner.query(`ALTER TABLE "groups" ALTER COLUMN "short_name" DROP DEFAULT`);
		...
		await queryRunner.query(
			`ALTER TABLE "events_groups" ADD CONSTRAINT "PK_a6aeb17233427f9165e96614484" PRIMARY KEY ("event_id")`,
		);
		...
		await queryRunner.query(
			`ALTER TABLE "events_groups" ADD CONSTRAINT "PK_3f4996f9f06ad47e98c6809e9be" PRIMARY KEY ("event_id", "group_id")`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "events_groups" ADD CONSTRAINT "FK_0593cf7f0f7560db1b5ad7a6f31" FOREIGN KEY ("group_id") REFERENCES "groups"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
		);
	}
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`ALTER TABLE "groups" DROP COLUMN "short_name"`);
	}
}
