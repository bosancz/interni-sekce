...
export class eventExpenseTypeEnum1682264978418 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."events_expenses_type_enum" AS ENUM('food', 'transport', 'material', 'accommodation', 'other')`);
        await queryRunner.query(`ALTER TABLE "events_expenses" ADD "type" "public"."events_expenses_type_enum" NOT NULL`);
        await queryRunner.query(`ALTER TYPE "public"."events_status_enum" RENAME TO "events_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."events_status_enum" AS ENUM('draft', 'pending', 'public', 'cancelled')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."events_status_enum_old" AS ENUM('draft', 'pending', 'public', 'cancelled', 'rejected')`);
        await queryRunner.query(`ALTER TABLE "events" ALTER COLUMN "status" DROP DEFAULT`);
