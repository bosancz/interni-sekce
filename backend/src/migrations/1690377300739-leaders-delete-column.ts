...
export class LeadersDeleteColumn1690377300739 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "members" ALTER COLUMN "role" TYPE "public"."members_role_enum" USING "role"::"text"::"public"."members_role_enum"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "members" ALTER COLUMN "role" TYPE "public"."members_role_enum_old" USING "role"::"text"::"public"."members_role_enum_old"`);
